  ...
  return (
    ...
    >
      ...
      >
        ...
        <AccordionContent className="text-secondary">
          Berri is for everyone. Whether it's work, relationships, or everyday
          life, stress is something we all experience-not just people with
          depression. Berri is designed to provide quick, accessible support for
          anyone dealing with daily stress, offering guidance without the need
      ...
      >
        ...
        <AccordionContent className="text-secondary">
          Each session lasts 15 minutes, offering quick, focused guidance on
          whatever you're facing at the moment. In addition to these sessions,
          you also have access to 24/7 chat support for real-time help. Rest
          assured, all your data is encrypted-whether through chat or voice
          calls-so no one will ever know what you write or discuss. Your privacy
          is 100% protected.
        </AccordionContent>
      </AccordionItem>
