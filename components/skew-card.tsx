...
interface CardSkewProps {
  className?: string;
  image: string;
}

export default function CardSkew({ className, image }: CardSkewProps) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "flex items-center justify-center max-w-fit transform-gpu flex-col gap-4 rounded-3xl bg-neutral-100 transition-transform ease-linear will-change-transform",
        className
      )}
      style={{
